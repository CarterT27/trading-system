...
_BUILTIN_STRATEGIES: Dict[str, Type[Strategy]] = {
    ...
    "crypto_competition_portfolio": CryptoCompetitionPortfolioStrategy,
    "crypto_comp_portfolio": CryptoCompetitionPortfolioStrategy,
    "crypto_meta_portfolio": CryptoCompetitionPortfolioStrategy,
