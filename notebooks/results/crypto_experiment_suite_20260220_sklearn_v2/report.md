...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| meta_model | 4 | 0.037 | 31.801 | 32.218 | 100.00% | 0.154 | 28.388 | 2.635 | -0.008 | 0.093 |
...
| 1 | meta_model | 0.117 | 37.753 | 0.029 | 21.283 | 2.095 | -0.007 | regime[short=30,long=180,slope=120,vol_w=1440,vol_q=0.80] | prob_threshold=0.5 |
...
| 2 | meta_model | 0.074 | 38.786 | 0.050 | 30.437 | 3.577 | -0.008 | regime[short=20,long=120,slope=120,vol_w=1440,vol_q=0.80] | prob_threshold=0.5 |
...
| 3 | meta_model | 0.055 | 25.758 | 0.021 | 41.483 | 1.534 | -0.001 | regime[short=20,long=120,slope=120,vol_w=1440,vol_q=0.60] | prob_threshold=0.5 |
...
| 4 | meta_model | 0.179 | 44.154 | 0.047 | 33.999 | 3.338 | -0.006 | regime[short=20,long=180,slope=120,vol_w=1440,vol_q=0.70] | prob_threshold=0.5 |
...
- Meta model uses sklearn `LogisticRegression` with per-symbol training and probability gating.
