...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| meta_model | 4 | 0.034 | 32.312 | 34.619 | 100.00% | 0.144 | 28.623 | 2.462 | -0.011 | 0.070 |
...
| --- | --- | --- |
| meta_model | add_now | Improves pooled return with acceptable drawdown and fold stability. |
| dynamic_sizing | add_now | Improves pooled return with acceptable drawdown and fold stability. |
| quality_filter | add_now | Improves pooled return with acceptable drawdown and fold stability. |
| exit_analysis | add_now | Improves pooled return with acceptable drawdown and fold stability. |
...
| 1 | meta_model | 0.131 | 39.845 | 0.028 | 20.573 | 2.031 | -0.011 | regime[short=30,long=180,slope=120,vol_w=1440,vol_q=0.80] | prob_threshold=0.5 |
...
| 2 | meta_model | 0.072 | 42.367 | 0.062 | 38.616 | 4.412 | -0.004 | regime[short=20,long=120,slope=120,vol_w=1440,vol_q=0.80] | prob_threshold=0.5 |
...
| 3 | meta_model | 0.038 | 23.497 | 0.014 | 39.439 | 1.011 | -0.001 | regime[short=20,long=120,slope=120,vol_w=1440,vol_q=0.60] | prob_threshold=0.5 |
...
| 4 | meta_model | 0.167 | 42.138 | 0.033 | 30.622 | 2.406 | -0.003 | regime[short=20,long=180,slope=120,vol_w=1440,vol_q=0.70] | prob_threshold=0.5 |
